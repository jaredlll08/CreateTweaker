...
public class MillingManager implements IRecipeManager {
    ...
    public void addRecipe(String name, MCWeightedItemStack[] output, IIngredient input) {
        ...
        ProcessingRecipeBuilder<MillingRecipe> builder = new ProcessingRecipeBuilder<>(((ProcessingRecipeSerializer<MillingRecipe>) AllRecipeTypes.MILLING.serializer).getFactory(), resourceLocation);
    ...
    @Override
    public IRecipeType<MillingRecipe> getRecipeType() {
