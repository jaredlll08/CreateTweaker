...
class DefaultPlugin : Plugin<Project> {
    ...
    private fun setupDefaults(project: Project) {
        ...
        project.repositories {
            ...
            this.add(this.maven("https://maven.tterrag.com") {
                name = "Create"
                content {
            ...
            this.add(this.maven("https://squiddev.cc/maven") {
                name = "squiddev"
                content {
            ...
            this.add(this.maven("https://maven.jamieswhiteshirt.com/libs-release") {
                content {
